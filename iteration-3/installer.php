...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'iteration_3_1ede9cfb6d40bfe56047_20221020082523_archive.zip';
        const ARCHIVE_SIZE       = '157634376';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1ede9cf-20082523';
        const SECONDARY_PACKAGE_HASH = '32c6cd0-20082523';
        const VERSION            = '1.5.0';
