...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'iteration_2_b47b7824023731f52903_20220921031309_archive.zip';
        const ARCHIVE_SIZE       = '182389444';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b47b782-21031309';
        const SECONDARY_PACKAGE_HASH = '144b86b-21031309';
        const VERSION            = '1.5.0';
